...
public abstract class Pet {
    ...
    protected hw9.Species species;
    protected String nickname;
    protected int age;
    protected int trickLevel;
    protected Set<String> habits;
    public hw9.Species getSpecies() {
        return species;
    }
    public void setSpecies(hw9.Species species) {
